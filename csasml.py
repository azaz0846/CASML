...
class SplitandMix(nn.Module):
    """
    Implementation of one CSASML block.
    """
...
class CSASML(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000, 
        ...
        self.stages = nn.ModuleList() # each stage consists of multiple CSASML blocks
